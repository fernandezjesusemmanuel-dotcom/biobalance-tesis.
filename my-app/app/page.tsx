...
export default async function Dashboard() {
  ...
  // REDIRECCIÓN SI FALTAN DATOS (Esto activa el Onboarding)
  if (!profile || !profile.first_name || !profile.age || !profile.gender) {
    redirect('/onboarding')
  }
      ...
      <div className="px-6 -mt-8 relative z-20 space-y-8">
        {hasRoutine ? (
            ...
            <div className="bg-white rounded-3xl p-8 text-center shadow-lg border border-stone-100 animate-in zoom-in-95 duration-500">
                ...
                <p className="text-stone-500 text-sm mb-6">Aún no has generado tu plan de entrenamiento inteligente.</p>
