...
import { Home, Plus, Dumbbell, History, GraduationCap } from 'lucide-react'
  ...
  return (
    <div className="fixed bottom-6 left-6 right-6 z-50">
      <div className="bg-stone-900/95 backdrop-blur-md text-stone-400 p-2 rounded-3xl shadow-2xl flex justify-between items-center px-6 border border-white/10">
        ...
        <Link href="/academic">
          <div
            className={`p-3 rounded-xl transition-all ${isActive('/academic') ? 'bg-teal-500/20 text-teal-400' : 'hover:text-white'}`}
          >
