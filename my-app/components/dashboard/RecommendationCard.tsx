...
import type { DailyLogRecommendation } from '@/types/routine'

interface Props { dailyLog: DailyLogRecommendation | null; }

export default function RecommendationCard({ dailyLog }: Props) {
